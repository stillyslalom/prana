...
'Parent',h_gridsetuppanel,...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String',{  'Standard Cross Correlation (SCC)'; 'Robust Phase Correlation (RPC)'; 'Dynamic Robust Phase Correlation (DRPC)'; 'Generalized Cross Correlation (GCC)'; 'Fraction-Filter Weighted Correlation (FWC)'; 'Spectral Phase Correlation (SPC)'; 'Direct Cross Correlation (DCC)'; 'High Speed Cross Correlation (hsSCC)' },...
'Style','popupmenu',...
'Value',1,...
