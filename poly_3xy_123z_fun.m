...
elseif orderz==4                % DaVis: 2 cubic xy planes
    ...
    Xgrid=aX(1) + aX(2).*x1 + aX(3).*x2 + aX(4).*x3 + aX(5).*x1.^2 +...
        ...
        aX(13).*x2.^3 + aX(14).*x1.^2.*x3 + aX(15).*x1.*x2.*x3 +...
        aX(16).*x2.^2.*x3 + ...
        aX(17).*x1.^2.*x2.*x3 + aX(18).*x1.*x2.^2.*x3 + ...
        aX(19).*x1.^3.*x3 + aX(20).*x2.^3.*x3;
    ...
    Ygrid=aY(1) + aY(2).*x1 + aY(3).*x2 + aY(4).*x3 + aY(5).*x1.^2 +...
        ...
        aY(13).*x2.^3 + aY(14).*x1.^2.*x3 + aY(15).*x1.*x2.*x3 +...
        aY(16).*x2.^2.*x3 + ...
        aY(17).*x1.^2.*x2.*x3 + aY(18).*x1.*x2.^2.*x3 + ...
        aY(19).*x1.^3.*x3 + aY(20).*x2.^3.*x3;    

else             % pinhole
    warning('Camera pinhole model not implemented in poly_3xy_123z_fun')
