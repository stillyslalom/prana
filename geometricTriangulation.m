...
%[z1grid]= geometricTriangulation(xgrid,x2grid,ygrid,y2grid,zgrid,Dux,Duy,aXcam1,aYcam1,aXcam2,aYcam2,caldata)
...
%modified later on;  
%JJC: Does my minimization-based approach fix this?  Finds the closest
%approach of rays cast from both the x and y disparity pairs.
